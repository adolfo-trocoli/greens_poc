...
weights_path = '/root/yolo/girasol/best.pt'                        # Se elige 'best.pt' (y no 'last.pt') porque contiene los pesos del modelo que logró mejores resultados en la validación durante el proceso de entrenamiento
